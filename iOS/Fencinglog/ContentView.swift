    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("Numbers") {
                    TextField("Touches scored (touches)", text: $value1Text)
                        .keyboardType(.decimalPad)
                        .focused($focusedField, equals: .value1)
                        .accessibilityIdentifier("value1Field")
                    TextField("Touches against (touches)", text: $value2Text)
                        .keyboardType(.decimalPad)
                        .focused($focusedField, equals: .value2)
                        .accessibilityIdentifier("value2Field")
                }
                Section("Drills practiced") {
                    TextField("Notes", text: $notes, axis: .vertical)
                        .focused($focusedField, equals: .notes)
                        .accessibilityIdentifier("notesField")
                }
            }
            .navigationTitle(entry == nil ? "New Bout" : "Edit Bout")
            .toolbar {
